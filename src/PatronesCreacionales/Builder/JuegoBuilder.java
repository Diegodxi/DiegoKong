...
import PatronesComportamiento.Observer.PoderLlamado;
...
import Entidades.*;
import PatronesComportamiento.State.JuegoEstadoLlamado;
...
public class JuegoBuilder {
    ...
    public JuegoBuilder inicializarHandler() {
      ...
      public JuegoBuilder inicializarEventos() {
        ...
        eventManager.registarJugadorListener(new JuegoEstadoLlamado(estadoJuego));
        eventManager.registarJugadorListener(new PoderLlamado());
