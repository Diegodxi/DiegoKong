...
/**
 * Handler sistema de capas de renderizado
 * 
...
public class Handler {
    ...
    public void render(Graphics g){
        ...
        renderCapa(g, ObjetosID.Bloque, true);
        ...
        estadoJuego.renderHUD(g, 
            PatronesEstructurales.Facade.Juego.getVentanaWidth(), 
            PatronesEstructurales.Facade.Juego.getVentanaHeight()
        );
    }
    }
